...
// TODO replace as soon as JOML releases 1.9.4
public class BoundingRect {
	...
	/**
	 * These should generally be considered coordinates of bounding points between items rather than indexes of items themselves. e.g. 0,0,1,1 would contain one
	 * item, not four.
	 */
